  ...
  <div className="webscape-header section-padding" id="home">
    <div className="webscape-header-content">
      <h1 className="gradient-text">
        Explore our latest inventions with &apos; WebScape &apos; !
      </h1>
      <p>
        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Provident
        dolore saepe exercitationem illo, et enim rerum reprehenderit optio
        doloremque, excepturi illum magnam labore assumenda ducimus ad repellat
        atque consectetur at!
      </p>
